...
/**
* corba/MyDataHelper.java .
* 由IDL-to-Java 编译器 (可移植), 版本 "3.2"生成
* 从TFile.idl
* 2019年3月27日 星期三 下午09时12分11秒 CST
*/

abstract public class MyDataHelper
{
  private static String  _id = "IDL:corba/MyData:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (corba.MyDataHelper.id (), "MyData", __typeCode);
    }
    return __typeCode;
  }
